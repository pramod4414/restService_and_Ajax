 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://provider.bv.com/", wsdlLocation = "http://localhost:9999/ws/01_Webservice_Provider?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://provider.bv.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/01_Webservice_Provider?WSDL");
    ...
    public Helloworld getHelloWorldImplPort() {
        return super.getPort(new QName("http://provider.bv.com/", "HelloWorldImplPort"), Helloworld.class);
    }
    ...
    public Helloworld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://provider.bv.com/", "HelloWorldImplPort"), Helloworld.class, features);
    }
